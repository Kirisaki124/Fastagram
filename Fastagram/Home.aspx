    ...
    <div class="container">
        <form runat="server">
            <div class="upload">
                ...
                <asp:FileUpload ID="fuImage" runat="server" accept=".jpg, .png, .jpeg" hidden/>
                <asp:Button ID="btnUpload" runat="server" Text="Post" OnClick="btnUpload_Click" CssClass="post-button" />
            </div>
        </form>
        <%
